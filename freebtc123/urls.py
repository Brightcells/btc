...
urlpatterns = patterns('freebtc123.views',
    ...
    url(r'^btcreaper$', 'btcreaper', name='btcreaper'),
    url(r'^next/(?P<num>\d+)/$', 'next', name='next'),
    url(r'^btcreaper/(?P<csyid>\d+)/$', 'btcreaper', name='btcreaper'),
    url(r'^next/(?P<num>\d+)/(?P<csyid>\d+)/$', 'next', name='next'),
    ...
    url(r'^dustbin$', 'dustbin', name='dustbin'),
    ...
    url(r'^newtobtc$', 'newtobtc', name='newtobtc'),
)

...
class Site(models.Model):
    ...
    siteUrlNoRefer = models.CharField(_(u'siteurlnorefer'), max_length=255, blank=True, null=True)
    ...
    siteProofNum = models.IntegerField(_(u'siteproofnum'), blank=True, null=True, default=0)
